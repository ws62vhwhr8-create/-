          ...
          <div className="w-full space-y-6">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex items-center gap-2">
                <Badge variant="outline" className="flex items-center gap-1 dark:border-[#464554]/30 dark:text-[#c7c4d7]">
            ...
            <Card className="dark:bg-[#1E1E1E] dark:border-[#333333] dark:bg-[#1E1E1E]/60 dark:border-white/15 dark:backdrop-blur-2xl dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.25),inset_0_-1px_0_rgba(255,255,255,0.06),0_10px_30px_rgba(0,0,0,0.35)]">
            ...
            <Card className="dark:bg-[#1E1E1E] dark:border-[#333333] dark:bg-[#1E1E1E]/60 dark:border-white/15 dark:backdrop-blur-2xl dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.25),inset_0_-1px_0_rgba(255,255,255,0.06),0_10px_30px_rgba(0,0,0,0.35)]">
              ...
              {isWorkflowOpen && (
                ...
                {formData.stages.map((stage, stageIndex) => (
                  <div key={stage.id}>
                    <div className="flex items-center gap-3 bg-gray-50 dark:bg-[#2a2a2a] p-3 rounded-xl border border-gray-100 dark:border-[#464554]/30">
                      ...
                      <span className="w-8 h-8 flex items-center justify-center bg-white dark:bg-[#353534] rounded-full text-xs font-bold text-gray-400 dark:text-[#c7c4d7] border border-gray-200 dark:border-[#464554]">
                        {stageIndex + 1}
                      </span>
                      <Input
                        value={stage.name}
                    ...
                    {expandedStages.has(stage.id) && stage.children && stage.children.map((child2, child2Index) => (
                      <div key={child2.id}>
                        <div className="flex items-center gap-3 bg-blue-50 dark:bg-[#c0c1ff]/5 p-3 rounded-xl border border-blue-100 dark:border-[#c0c1ff]/20 ml-4 mt-2">
                          {child2.children && child2.children.length > 0 ? (
                            <button
                              type="button"
                              onClick={() => toggleExpand(child2.id)}
                              className="w-6 h-6 flex items-center justify-center hover:bg-blue-100 rounded"
                            >
                          ...
                          <span className="min-w-8 h-8 px-2 flex items-center justify-center bg-white dark:bg-[#353534] rounded-full text-xs font-bold text-blue-400 dark:text-[#c0c1ff] border border-blue-200 dark:border-[#c0c1ff]/30">
                        ...
                        {expandedStages.has(child2.id) && child2.children && child2.children.map((child3, child3Index) => (
                          <div key={child3.id} className="flex items-center gap-3 bg-purple-50 dark:bg-[#ddb7ff]/5 p-3 rounded-xl border border-purple-100 dark:border-[#ddb7ff]/20 ml-8 mt-2">
                            <div className="w-6" />
                            <span className="min-w-8 h-8 px-2 flex items-center justify-center bg-white dark:bg-[#353534] rounded-full text-xs font-bold text-purple-400 dark:text-[#ddb7ff] border border-purple-200 dark:border-[#ddb7ff]/30">
                            ...
                            <div className="flex items-center gap-2 w-28 shrink-0">
                              <Input
                                ...
                                className="text-center bg-white dark:bg-[#1E1E1E] dark:border-[#464554]/50"
                              />
                              <span className="text-xs text-purple-400 dark:text-[#ddb7ff]">일</span>
                            </div>
            ...
            <div className="flex justify-end gap-2">
              <Button variant="outline" onClick={() => router.push("/solutions")}>목록으로</Button>
